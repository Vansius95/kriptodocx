      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="@if(Request::segment(1) == 'dashboard') active @endif"><a href="{{route('dashboard')}}">Beranda <span class="sr-only">(current)</span></a></li>
            <!-- <li><a href="{{route('users')}}">Administrator</a></li> -->
            <li class="@if(Request::segment(1) == 'crypto' && Request::segment(2) == 0) active @endif"><a href="{{url('crypto/0')}}">Enkripsi</a></li>
            <li class="@if(Request::segment(1) == 'crypto' && Request::segment(2) == 1) active @endif"><a href="{{url('crypto/1')}}">Dekripsi</a></li>
