...
@section('content')
    ...
    <div class="box box-default">
      <div class="box-body">
        ...
        <ul>
            <li> Dokumen yang akan di enkripsi hanya dokument format docx</li>
            <li> Dokumen yang dienkripsi hanya pada teks (karakter) dalam dokumen</li>
            <li> Jika dokumen berisi gambar, maka gambar tidak akan dienkripsi dan kemungkinan terjadi error pada proses enkripsi</li>
        </ul>
      </div>
      <!-- /.box-body -->
    </div>
